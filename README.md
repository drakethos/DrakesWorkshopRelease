...
**Current:** [v0.2.28](https://github.com/drakethos/DrakesWorkshopRelease/releases/tag/v0.2.28)  -  Light (no key) + optional Alpha (`DWK-`). Download **Full Setup** (content included); auto-updates stay slim.
